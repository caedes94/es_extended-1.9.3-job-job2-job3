...
local loadPlayer = 'SELECT `accounts`, `job`, `job_grade`, `job2`, `job2_grade`, `job3`, `job3_grade`, `group`, `position`, `inventory`, `skin`, `loadout`'
...
function loadESXPlayer(identifier, playerId, isNew)
  local userData = {accounts = {}, inventory = {}, job = {}, job2 = {}, job3 = {}, loadout = {}, playerName = GetPlayerName(playerId), weight = 0}
  ...
  if ESX.DoesJobExist(job3, grade3) then
    ...
    print(('[^3WARNING^7] Ignoring invalid job3 for %s [job3: %s, grade3: %s]'):format(identifier, job3, grade3))
  ...
  if grade3Object.skin_male then userData.job3.skin_male = json.decode(grade3Object.skin_male) end
  if grade3Object.skin_female then userData.job3.skin_female = json.decode(grade3Object.skin_female) end

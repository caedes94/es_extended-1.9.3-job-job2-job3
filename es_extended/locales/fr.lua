Locales['fr'] = {
  ...
  -- Salary related
  ['received_salary']  = '~y~vous avez reçu votre salaire:~g~ $%s',
  ['received_salary2'] = '~o~vous avez reçu votre salaire:~g~ $%s',
  ['received_salary3'] = '~b~vous avez reçu votre salaire:~g~ $%s',
